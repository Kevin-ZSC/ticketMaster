...
const TicketForm = () => {
  ...
  const validate = () => {
    ...
    if (
      ...
      !securityCodeRegex.test(formData.securityCode)
    ) {
    ...
    if (!formData.address || formData.address.length > 100) {
      newErrors.address =
        "Address is required and cannot exceed 100 characters";
    }
    ...
    if (!formData.province || formData.province.length > 50) {
      newErrors.province =
        "Province/State is required and cannot exceed 50 characters";
    }
    ...
    if (!formData.postalCode || !postalRegex.test(formData.postalCode)) {
      newErrors.postalCode =
        "Please provide a valid Canadian postal code (e.g., A1B 0A1)";
    }
  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto mb-8 text-center">
        ...
        <p
          className="mt-3 text-xl text-white drop-shadow-md"
          style={{ fontFamily: "'Poppins', sans-serif" }}
        >
          Get tickets to the hottest concerts in town
        </p>
      </div>
      <div className="max-w-4xl mx-auto bg-white/70 backdrop-blur-sm  rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-purple-600/90 to-indigo-600/90 px-6 py-8 md:p-10">
          <h1
            className="text-4xl font-extrabold text-white text-center"
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            <span className="block">Jay Chou</span>
            <span className="block text-2xl mt-2 font-light">
              Carnival World Tour
            </span>
          </h1>
          <p
            className="mt-3 text-purple-100 text-center italic"
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
